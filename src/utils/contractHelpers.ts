...
export const getGrimexContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(cakeAbi, getGrimexAddress(), signer)
}
...
export const getNftMintContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(nftMintAbi, getNftMintAddress(), signer)
}
